...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
	adventurerCardFunc(currentPlayer, temphand, state);
	return 0;
    ...
    case mine:
	mineCardFunc(currentPlayer, choice1, choice2, handPos, state);
	return 0;
    ...
    case smithy:
      smithyCardFunc(currentPlayer, handPos, state);
      return 0;
    ...
    case minion:
	 minionCardFunc(currentPlayer, handPos, choice1, choice2, state);
	return 0;
      //+1 action
  /*    state->numActions++;
      ...
      else if (choice2)		//discard hand, redraw 4, other players with 5+ cards discard hand and draw 4
	{
	  ...
	  for (i = 0; i < state->numPlayers; i++)
		...
		*/
    case steward:
	 stewardCardFunc(currentPlayer, handPos, choice1, choice2, choice3, state);
	return 0;
